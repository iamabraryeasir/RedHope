    ...
    <footer className="w-full bg-[#FAFAFB]   py-15">
      <div className="first mx-5 sm:mx-20">
        <div className="logo flex flex-row gap-2 items-center">
          <img
            className="h-[15px] w-[15px] sm:h-auto sm:w-auto "
            src="/logo-icon.png"
            alt=""
          />
          <h2 className="text-[11px] font-[400] sm:text-2xl leading-[160%]   tracking-[-1.28px] ">
            Redhope
          </h2>
        </div>
      </div>
      <div className="all flex flex-row  mt-5 justify-between mx-5 sm:mx-20 ">
        <div className="one ">
          <h2 className="text-[8px] leading-[170%] sm:text-[16px] font-[500] ">
            <a href="#">Donation</a>
          </h2>
          <h2 className="text-[8px] leading-[170%]  sm:text-[16px] font-[400]">
            <a href="#">About</a>
          </h2>
          <h2 className="text-[8px] leading-[170%]  sm:text-[16px] font-[400]">
            <a href="#">User</a>
      ...
      <div className="copy mx-5 sm:mx-20 mt-5 flex justify-between">
        <h3 className="text-[5px]  leading-[170%]  sm:text-[16px] font-[400]">
