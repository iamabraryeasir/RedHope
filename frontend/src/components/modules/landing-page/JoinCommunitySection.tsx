...
export default function JoinCommunitySection() {
  return (
    <section className="mx-2 sm:max-w-2xl lg:max-w-7xl sm:mx-auto lg:mx-auto">
      <div className="container h-[180px] sm:h-72 rounded-2xl bg-gradient-to-br from-[#570C0C] via-[#932A2A] to-[#000000]  w-full  flex flex-col items-center justify-center  ">
        ...
        <button className="flex flex-row items-center justify-center bg-white rounded-4xl py-1 px-2 sm:py-2 sm:px-5  mt-6 ">
