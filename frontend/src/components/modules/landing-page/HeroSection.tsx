...
export default function HeroSection() {
  return (
    <section className=" text-center mx-auto sm:max-w-2xl lg:max-w-7xl sm:mx-auto lg:mx-auto ">
      <h2 className="text-7xl font-[600] mt-16 leading-[117%] tracking-[-2px] ">
        Your Next <span className="text-[#A21C1C]">Blood</span> Donor is Here.
      </h2>

      <p className="text-[20px]  leading-[170%] mt-[16px]  ">
        Join our community of voluntary blood donors and be a lifeline for those
        in need.
      </p>
      <div className="buttons  mt-10  flex items-center justify-center   ">
        <button className="flex items-center  mr-3 shadow-lg  shadow-black bg-gradient-to-br from-[#570C0C] via-[#932A2A] to-[#000000] px-14 py-4  rounded-4xl text-white text-[16px] font-[500]  ">
          Find a Donor Now{" "}
          <div className="bg-white rounded-full text-black  p-1 ml-5">
            <ArrowRight />
          </div>
        </button>
        <button className="bg-white border-[1px] shadow-lg   shadow-black  border-black px-14 py-4 rounded-4xl  ">
          Explore Us
        </button>
      </div>
