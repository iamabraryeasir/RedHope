...
export default function RequestsPage() {
  ...
  if (!raw) {
    ...
    else if (tryArray(obj.data)) requests = tryArray(obj.data) as IRequest[];
    else if (obj.data && typeof obj.data === "object") {
      const inner = obj.data as { [k: string]: unknown };
      if (tryArray(inner.data)) requests = tryArray(inner.data) as IRequest[];
  ...
  return (
    <div className="py-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button onClick={() => navigate("/requests/create-new-request")}>
          <Plus />
          Request For Blood
        </Button>
      </div>
